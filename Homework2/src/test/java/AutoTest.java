...
public class AutoTest extends BaseTest {
    ...
    @Parameterized.Parameter(1) // first data value (0) is default
    public String b;
    ...
    public void exampleScenario() {
        ...
        String titleXpath = "//h1[contains(text(), 'Добровольное медицинское страхование')]"; // need fix
        ...
        // Проверить наличие заголовка - "Добровольное страхование здоровья"
        String title2Xpath = "//h2[contains(text(), 'Оперативно перезвоним')]"; // need fix
        ...
        String errorAlertXPath = "//span[contains(text(), 'Введите корректный адрес электронной почты')]"; // need fix
...
//                "Введите корректный адрес электронной почты", errorAlert.getText());
        MatcherAssert.assertThat("Проверка сообщения об ошибке у поля с эл почтой",
     ...
     */
    private WebElement waitUtilElementToBeVisible(WebElement element) {
